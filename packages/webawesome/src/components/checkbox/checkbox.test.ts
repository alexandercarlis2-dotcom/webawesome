    ...
    describe(`with "${fixture.type}" rendering`, () => {
      ...
      describe('slots', () => {
        it('should render the default slot for label content', async () => {
          const el = await fixture<WaCheckbox>(html`<wa-checkbox>Checkbox Label</wa-checkbox>`);
        ...
        it('should display hint text via the hint attribute', async () => {
          const el = await fixture<WaCheckbox>(html`<wa-checkbox hint="Help text">Checkbox</wa-checkbox>`);
      ...
      describe('form integration', () => {
        ...
        it('should be invalid when setCustomValidity() is called with a non-empty value', async () => {
          const checkbox = await fixture<WaCheckbox>(html`<wa-checkbox></wa-checkbox>`);
        ...
        it('should be valid when required and checked', async () => {
          const el = await fixture<WaCheckbox>(html`<wa-checkbox required checked></wa-checkbox>`);
          await el.updateComplete;
          expect(el.checkValidity()).to.be.true;
        });
